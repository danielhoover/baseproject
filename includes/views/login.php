...
<div id="main">
    <div class="row">
        ...
        <form method="post" action="login" class="form-horizontal col-12">
            ...
            <div class="form-group row">
                <label for="username" class="col-12 col-md-2">Benutzername</label>
                <div class="col-12 col-md-10">
                    <input type="text" name="username" id="username" class="text form-control" value="" placeholder="Benutzername">
                </div>
            </div>
            <div class="form-group row">
                <label for="password" class="col-12 col-md-2">Passwort</label>
                <div class="col-12 col-md-10">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form method="post" action="login" class="col-12 needs-validation" novalidate>

                            <div class="form-group">
                                <label for="name">Benutzername:</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Benutzernamen eingeben" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pwd" class="form-control" id="pwd" placeholder="Bitte Passwort eingeben (mind. 8 Zeichen)" minlength="8" required>
                            </div>
                            <div class="form-group">
                                <label for="pwd2">Passwort (wiederholen):</label>
                                <input type="password" name="pwd2" class="form-control" id="pwd2" placeholder="Bitte das Passwort wiederholen" minlength="8" required>
                                <div class="invalid-feedback">
